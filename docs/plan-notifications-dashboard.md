...
|---|---|
| macOS 13+ | `open "x-apple.systempreferences:com.apple.Notifications-Settings.extension?id=<bundle id of the backend app>"` (terminal-notifier: `fr.julienxx.terminal-notifier`; osascript: `com.apple.ScriptEditor2`); without `?id=` it opens the Notifications pane |
